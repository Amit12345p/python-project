...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'apatel816@rku.ac.in' ")
...
window.configure(background='#FF8000')

frame1 = tk.Frame(window, bg="#808A87")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#808A87")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance System", fg="#FFFF00", bg="#8B8989",
...
frame4 = tk.Frame(window, bg="#C0FF3E")
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="blue",
                 bg="#8B5A00", font=('comic', 17, ' bold '))
head2.grid(row=0, column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="blue",
                 bg="#8B5A00", font=('comic', 17, ' bold '))
head1.place(x=0, y=0)

lbl = tk.Label(frame2, text="Enter ID", width=20, height=1, fg="black", bg="#808A87", font=('comic', 17, ' bold '))
lbl.place(x=80, y=55)

txt = tk.Entry(frame2, width=32, fg="black", font=('comic', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name", width=20, fg="black", bg="#808A87", font=('comic', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2, width=32, fg="black", font=('comic', 15, ' bold '))
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile", bg="#808A87", fg="green", width=39, height=1,
...
clearButton = tk.Button(frame2, text="Clear", command=clear, fg="black", bg="#EE0000", width=11,
                        activebackground="white", font=('comic', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="black", bg="#EE0000", width=11,
                         activebackground="white", font=('comic', 11, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="black", bg="#00ffff", width=35, height=1,
                     activebackground="white", font=('comic', 15, ' bold '))
trackImg.place(x=30, y=50)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy, fg="black", bg="#CD0000", width=35, height=1,
                       activebackground="white", font=('comic', 15, ' bold '))
